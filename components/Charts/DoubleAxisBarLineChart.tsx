...
const options = (chartId: string, series: AreaChartState) : ApexOptions => {
    return {
        legend: {
            show: true,
            position: "top",
        ...
        yaxis:[ {
            seriesName: series.series[0].name,
            title: {
                style: {
                    fontSize: "0px",
                },
            ...
            seriesName: series.series[1].name,
            opposite: true,
            title: {
                style: {
                    fontSize: "0px",
...
const DoubleAxisBarLineChart: React.FC<{props: AreaChartState, chartId: string, title: string}> = 
    ({props, chartId, title} :{props: AreaChartState, chartId: string, title: string}) => {
