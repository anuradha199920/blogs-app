...
const subtitle = "WITH OUR ON CHAIN ANALYTIS";
    ...
    return (
        ...
        <div className="lg:h-full w-[98%] mt-10 pb-0 mx-4  rounded-xl relative min-h-[calc(100vh-40vh)] py-0">
            ...
            <div className="mx-auto px-5 py-20 w-[100%] absolute lg:bottom-[50%] left-[5%]">
                <h1 className="mt-2 text-3xl font-semibold stylish-font text-[#3C61BD] xl:text-5xl lg:leading-tight w-[100%] tracking-tighter ">
                    {title}
                </h1>
